...
# Cargar los datos
uwind = xr.open_dataset('C:/Users/ferfo/OneDrive/Escritorio/uwnd2012-200.nc')
vwind = xr.open_dataset('C:/Users/ferfo/OneDrive/Escritorio/vwnd2012-200.nc')

# Extraer variables de viento
...
# Calcular la divergencia del viento
...
divergencia_xr = xr.DataArray(
    ...
    attrs={"units": "1/s", "long_name": "Divergencia del viento"}
)
...
levels = np.linspace(-1.1e-5, 1.1e-5, 11)  # Ajustar niveles si es necesario
cmap = plt.cm.PuOr_r
...
ax.streamplot(
    ...
    color='black',
    linewidth=0.8,
    density=3,  # Ajustar densidad según sea necesario
    arrowsize=1
)
...
plt.savefig('C:/Users/ferfo/OneDrive/Escritorio/div2.png', dpi=300, bbox_inches='tight')
plt.show()
